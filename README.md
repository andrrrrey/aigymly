...
Бесплатно доступны календарь, базовая статистика и **одна** пробная программа от AI. По подписке
Ai Gymly Pro открываются ИИ-анализ прогресса после каждой тренировки и создание дополнительных
программ (в пределах месячных квот).
...
- **БД**: Postgres + Prisma. Модели: `User`, `Workout`, `Exercise`, `ExerciseSet`, `Questionnaire`, `Program`
